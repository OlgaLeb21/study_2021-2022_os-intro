...
![Создание подкаталога](1.png){ #fig:001 width=70% }

Записали код в три созданных файла. (рис. [-@fig:002]) (рис. [-@fig:003]) (рис. [-@fig:004])

![Содержание calculate.c](2.png){ #fig:002 width=70% }

![Содержание main.c](3.png){ #fig:003 width=70% }

![Содержание calculate.h](4.png){ #fig:004 width=70% }
