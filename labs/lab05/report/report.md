...
![Команды touch, cat, tac](1.jpg){ #fig:001 width=70% }

![Команды head, tail](2.png){ #fig:002 width=70% }
...
![Проверили наличие файла io.h](3.png){ #fig:003 width=70% }

![Копировали файл io.h](4.png){ #fig:004 width=70% }

![Файл io.h в домашнем каталоге](5.png){ #fig:005 width=70% }

![Переименование файла](6.png){ #fig:006 width=70% }

В домашнем каталоге создали директорию ~/ski.plases. (рис. [-@fig:007])

![Создание директории](7.png){ #fig:007 width=70% }

Переместили файл equipment в каталог ~/ski.plases. (рис. [-@fig:008])

![Перемещение файла](8.png){ #fig:008 width=70% }

Переименовали файл /ski.plases/equipment в ~/ski.plases/equiplist. (рис. [-@fig:009]) 

![Переименование файла](9.png){ #fig:009 width=70% }

Создали в домашнем каталоге файл abc1 и скопировали его в каталог ~/ski.plases, назвали его equiplist2. (рис. [-@fig:011])

![Действия с файлом abc1](11.png){ #fig:011 width=70% }
...
![Переместили два файла](12.png){ #fig:012 width=70% }

![Проверка наличия файлов](13.png){ #fig:013 width=70% }

Создали и переместили каталог /newdir в каталог ~/ski.plases и назвали его plans. (рис. [-@fig:014])

![Действия с каталогом](14.png){ #fig:014 width=70% }
...
![man](39.png){ #fig:039 width=70% }

![mount](35.png){ #fig:035 width=70% }

![fsck](36.png){ #fig:036 width=70% }

![kill](37.png){ #fig:037 width=70% }

![mkfs](38.png){ #fig:038 width=70% }
