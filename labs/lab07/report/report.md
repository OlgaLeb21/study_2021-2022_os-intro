...
![Справка по команде mc](1.png){ #fig:001 width=70% }
...
Выполнили основные команды меню левой (или правой) панели. Оценители степень подробности вывода информации о файлах. (рис. [-@fig:002])

![Левая панель](2.png){ #fig:002 width=70% }

Используя возможности подменю Файл, выполнили:

– просмотр содержимого текстового файла; (рис. [-@fig:006])

![Просмотр содержимого файла](6.png){ #fig:006 width=70% }

– редактирование содержимого текстового файла (без сохранения результатов редактирования); (рис. [-@fig:005])

![Редактирование файла](5.png){ #fig:005 width=70% }

– создание каталога; (рис. [-@fig:004]) (рис. [-@fig:003])

![Создание каталога](4.png){ #fig:004 width=70% }

![Создание каталога](3.png){ #fig:003 width=70% }

– копирование в файлов в созданный каталог; (рис. [-@fig:008]) (рис. [-@fig:009])

![Копирование файла](8.png){ #fig:008 width=70% }

![Копирование файла](9.png){ #fig:009 width=70% }
...
![Поиск файлов](18.png){ #fig:018 width=70% }

![Поиск файлов](19.png){ #fig:019 width=70% }

– выбор и повторение одной из предыдущих команд;

– переход в домашний каталог; (рис. [-@fig:020])

![Переход в домашний каталог](20.png){ #fig:020 width=70% }

– анализ файла меню (рис. [-@fig:022]) и файла расширений. (рис. [-@fig:021])

![Анализ файла расширений](21.png){ #fig:021 width=70% }

![Анализ файла меню](22.png){ #fig:022 width=70% }
...
![Настройки](23.png){ #fig:023 width=70% }

![Настройки](24.png){ #fig:024 width=70% }

![Настройки](25.png){ #fig:025 width=70% }

![Настройки](26.png){ #fig:026 width=70% }

# Задание 2

1. Создали текстовой файл text.txt. (рис. [-@fig:027])

![Создание файла](27.png){ #fig:027 width=70% }

2. Открыли этот файл с помощью встроенного в mc редактора. Вставили в открытый файл небольшой фрагмент текста, скопированный из любого
другого файла или Интернета. (рис. [-@fig:030])

![Открытие файла](30.png){ #fig:030 width=70% }

3. Проделали с текстом следующие манипуляции, используя горячие клавиши:

- Удалили строку текста. (рис. [-@fig:031])

![Удаление строки](31.png){ #fig:031 width=70% }

- Выделили фрагмент текста и скопировали его на новую строку. (рис. [-@fig:032])

![Копирование строки](32.png){ #fig:032 width=70% }
