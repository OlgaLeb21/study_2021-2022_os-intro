...
![Записываем текст](4.png){ #fig:004 width=70% }

![Записали изменения](5.png){ #fig:005 width=70% }

Сделали файл исполняемым. (рис. [-@fig:006])

![Сделали файл исполняемым](6.png){ #fig:006 width=70% }
...
![Добавление строк, изменение](9.png){ #fig:009 width=70% }
...
![Команда u](10.png){ #fig:010 width=70% }

![Отмена последнего изменения](11.png){ #fig:011 width=70% }

Ввели символ : для перехода в режим последней строки. Записали произведённые изменения и вышли из vi. (рис. [-@fig:012])

![Просмотр файла](12.png){ #fig:012 width=70% }
